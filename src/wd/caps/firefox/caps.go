...
// Caps is the name of the Firefox-specific key in the WebDriver
// capabilities object.
const CapabilitiesKey = "moz:firefoxOptions"

// Caps provides Firefox-specific options to WebDriver.
type Caps struct {
...
func (c *Caps) SetProfile(basePath string) error {
	buf, err := common.ZipArchive(basePath)
	if err != nil {
		return err
	}
